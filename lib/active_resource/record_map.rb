...
module ActiveResource
  ...
  class << self
    def api_type_name_object_map
      ActiveSupport::Deprecation.warn("api_type_name_object_map is deprecated. Use record_map instead.")
      record_map
    end
    ...
    def map_object(api_type_name)
      ActiveSupport::Deprecation.warn("map_object is deprecated. Use record_map.resource_class instead.")
      record_map.resource_class(api_type_name)
    end

    def map_api_type_name(object)
      ActiveSupport::Deprecation.warn("map_api_type_name is deprecated. Use record_map.record_base_name instead.")
  ...
  module RecordMap
    ...
    class << self
      ...
      def find_object(api_type_name)
        ActiveSupport::Deprecation.warn("find_object is deprecated. Use resource_class(record) instead.")
      ...
      def find_object_namespace_fallback(api_type_name)
        ActiveSupport::Deprecation.warn("find_object is deprecated. Use resource_class_namespace_fallback instead.")
      ...
      def object_fallback(&block)
        ActiveSupport::Deprecation.warn("object_fallback is deprecated. Use _object_fallback instead.")
        @@object_fallback = block
      end

      def find_api_type_name(object)
        ActiveSupport::Deprecation.warn("find_api_type_name is deprecated. Use find_record_base_name(record) instead.")
      ...
      def api_type_name_fallback(&block)
        ActiveSupport::Deprecation.warn("api_type_name_fallback is deprecated. Use _api_type_name_fallback instead.")
        @@api_type_name_fallback = block
      end

      def api_type_name_of(object)
        ActiveSupport::Deprecation.warn("api_type_name_of is deprecated. Use record_name(record) instead.")
        record_name(object)
      end
    ...
    module RecordHelper
      ...
      class_methods do
        def api_type_name
          ActiveSupport::Deprecation.warn("api_type_name is deprecated. use record_base_name")
          record_base_name
        end
