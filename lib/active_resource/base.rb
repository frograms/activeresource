    ...
    class << self
      ...
      def site=(site)
        ...
        if site.nil?
          ...
          self._user = URI::RFC2396_PARSER.unescape(_site.user) if _site.user
          self._password = URI::RFC2396_PARSER.unescape(_site.password) if _site.password
        end
      end
      ...
      def prefix=(value = "/")
        ...
        prefix_call = value.gsub(/:\w+/) { |key| "\#{URI::RFC2396_PARSER.escape options[#{key}].to_s}" }
