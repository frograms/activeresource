    ...
    def from_json(json, save_cache = false)
      ...
      if decoded.kind_of?(Hash) && (decoded.has_key?("errors") || decoded.empty?)
        ...
        if errors.kind_of?(Array)
          ...
          Rails.deprecator.warn("Returning errors as an array of strings is deprecated.")
        ...
        Rails.deprecator.warn('Returning errors as a hash without a root "errors" key is deprecated.')
